...
if choix_inter == "PDP":  
    st.write("## PDP")  
    st.write("""Nous allons donc pouvoir visualiser l'effet marginal d'une variable spécifique sur la prédiction du modèle 
             tout en maintenant les autres variables constantes. Cette vue granulaire de la manière dont une caractéristique 
