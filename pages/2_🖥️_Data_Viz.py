...
if selection == "Données":
    ...
    # Sélecteur pour choisir entre les données temporelles et les corrélations
    ...
    """)
        ...
        # Histos correspondants en fonction de la sélection
        if selection == "Années":
            st.write("### Répartition du nombre d'incidents par année")
            # Tracé des histogrammes des années avec Altair
            ...
            # Affichage des histos des temps d'arrivée côte à côte 
            ...
            # Tracé des histogrammes des temps d'arrivée 
            ...
            # Affichage des histogrammes des temps d'arrivée côte à côte 
